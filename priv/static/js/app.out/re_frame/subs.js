...
var args8332 = [];
var len__7544__auto___8336 = arguments.length;
var i__7545__auto___8337 = (0);
while(true){
if((i__7545__auto___8337 < len__7544__auto___8336)){
args8332.push((arguments[i__7545__auto___8337]));

var G__8338 = (i__7545__auto___8337 + (1));
i__7545__auto___8337 = G__8338;
continue;
} else {
}
break;
...
var handler_fn = cljs.core.get.call(null,cljs.core.deref.call(null,re_frame.subs.key__GT_fn),key_v);
if(goog.DEBUG){
var temp__4657__auto___8340 = cljs.core.seq.call(null,cljs.core.remove.call(null,((function (key_v,handler_fn){
return (function (p1__8331_SHARP_){
if(!((p1__8331_SHARP_ == null))){
if((false) || (p1__8331_SHARP_.reagent$ratom$IReactiveAtom$)){
return true;
} else {
return false;
}
...
,dynv));
if(temp__4657__auto___8340){
var not_reactive_8341 = temp__4657__auto___8340;
re_frame.utils.warn.call(null,"re-frame: dynv contained parameters that don't implement IReactiveAtom: ",not_reactive_8341);
} else {
}
} else {
}
